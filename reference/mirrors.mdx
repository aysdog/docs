...
description: "Push the same repository to GitHub, GitLab, Gitea, and Forgejo at once. Add mirrors with commitdog init, push with platform flags, and release everywhere with release --all."
icon: "copy"
---
