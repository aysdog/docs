...
description: "Open PRs from feature branches with a diff viewer, or list, review, and merge open PRs from main — all from the terminal, on GitHub, GitLab, Gitea, or Forgejo."
