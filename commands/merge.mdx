---
title: "Merge branches with a diff preview and a generated commit message"
sidebarTitle: "merge"
description: "Pick a branch to merge into your current one, preview the diff and conflict status first, and get a detailed merge commit message generated from the branch's commits."
icon: "git-merge"
---
